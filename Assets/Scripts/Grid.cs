...
public class Grid<PathNode>
{
    ...
    [SerializeField] private PathNode[,] gridArray;

    public Grid(int width, int height, float cellSize, Vector3 originPosition, Func<Grid<PathNode>, int, int, PathNode> createGridObject)
    {
        this.width = width;
        this.height = height;
